...
interface EditorState {
  ...
  setSelectedSubElementId: (id: string | null) => void;
...
export const useEditorStore = create<EditorState>()(
  temporal(
    (set, get) => ({
      ...
      setSelectedId: (id) => set({ selectedId: id, selectedSubElementId: null }),
      
      setSelectedSubElementId: (id) => set({ selectedSubElementId: id }),
